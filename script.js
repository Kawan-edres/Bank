...
const startLogOutTimer=function(){
  ...
  const tick=function(){
    ...
    let sec=String(Math.trunc(time%60)).padStart(2,0)
      ...
      if(time===0){
        clearInterval(timer)
        labelWelcome.textContent="Login to see your Account"
...
console.log(900719925474099191929399219n);
...
// const day1=calcDaysPassed(new Date(2022,9,0),new Date(2022,9,17));
// console.log(day1);
